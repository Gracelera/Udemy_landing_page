var OneTrustStub = (function (e) {
  ...
  ((o = t = t || {})[(o.Unknown = 0)] = "Unknown"),
    ...
    (A.AfterDPD = "AfterDPD"),
    ((y = v = v || {}).PlusMinus = "Plusminus"),
    (y.Caret = "Caret"),
    (y.NoAccordion = "NoAccordion"),
    ...
    ((w = D = D || {})[(w.Disabled = 0)] = "Disabled"),
    (w[(w.Consent = 1)] = "Consent"),
    (w[(w.LegInt = 2)] = "LegInt"),
    ((B = T = T || {})[(B["Banner - Allow All"] = 1)] = "Banner - Allow All"),
    (B[(B["Banner - Reject All"] = 2)] = "Banner - Reject All"),
    (B[(B["Banner - Close"] = 3)] = "Banner - Close"),
    (B[(B["Preference Center - Allow All"] = 4)] =
      "Preference Center - Allow All"),
    (B[(B["Preference Center - Reject All"] = 5)] =
      "Preference Center - Reject All"),
    (B[(B["Preference Center - Confirm"] = 6)] = "Preference Center - Confirm"),
    ((E = R = R || {}).Active = "1"),
    (E.InActive = "0"),
    ((P = _ = _ || {}).Host = "Host"),
    (P.GenVendor = "GenVen"),
    ...
    ((G = O = O || {})[(G.minDays = 1)] = "minDays"),
    (G[(G.maxDays = 30)] = "maxDays"),
    (G[(G.maxYear = 31536e3)] = "maxYear"),
    (G[(G.maxSecToDays = 86400)] = "maxSecToDays"),
    ((V = F = F || {})[(V.RTL = 0)] = "RTL"),
    (V[(V.LTR = 1)] = "LTR"),
    ...
    (z.Toggle = "Toggle"),
    ((J = K = K || {}).SlideIn = "Slide_In"),
    (J.FadeIn = "Fade_In"),
    (J.RemoveAnimation = "Remove_Animation"),
    ((W = q = q || {}).Link = "Link"),
    (W.Icon = "Icon"),
    ...
    (oe.denied = "denied"),
    ((ne = ie = ie || {})[(ne.HostList = 0)] = "HostList"),
    (ne[(ne.IabVendors = 1)] = "IabVendors"),
    (ne[(ne.VendorServices = 2)] = "VendorServices"),
    ((re = ae = ae || {}).OBJECT_TO_LI = "ObjectToLI"),
  ...
  var ue = "geo",
    ...
    me = "PRODUCTION",
    he =
      (((ce = {})[M.Days] = "PCenterVendorListLifespanDay"),
      (ce[M.Weeks] = "LfSpnWk"),
      (ce[M.Months] = "PCenterVendorListLifespanMonth"),
      (ce[M.Years] = "LfSpnYr"),
      (ge.prototype.camelize = function (e) {
        return e
          .split("-")
          .map(function (e, t) {
  ...
  var be =
    ((Ae.prototype.initConsentSDK = function () {
    ...
    (Ae.prototype.captureNonce = function () {
      this.nonce =
        pe.stubScriptElement.nonce ||
        pe.stubScriptElement.getAttribute("nonce") ||
        null;
    }),
    (Ae.prototype.fetchBannerSDKDependency = function () {
      this.setDomainDataFileURL(),
        (this.crossOrigin =
          pe.stubScriptElement.getAttribute("crossorigin") || null),
        (this.previewMode =
          "true" === pe.stubScriptElement.getAttribute("data-preview-mode")),
        this.otFetch(pe.bannerDataParentURL, this.getLocation.bind(this));
    }),
    (Ae.prototype.setDomainIfBulkDomainEnabled = function (e) {
      ...
      if (
        ...
        if (a && a.getItem("bulkDomainMgmtEnabled"))
    ...
    (Ae.prototype.getLocation = function (e) {
      if (
        (this.setDomainIfBulkDomainEnabled(e),
        ((e.TenantFeatures && e.TenantFeatures.CookieV2CSP) ||
          e.CookieV2CSPEnabled) &&
          this.nonce &&
          ((this.setAttributePolyfillIsActive = !0),
          new he().implementThePolyfill()),
        !e.RuleSet[0].Type)
      )
        return (
          (this.iabTypeAdded = !1),
      ...
      if (t.OneTrust && t.OneTrust.geolocationResponse) {
        ...
        var i = this.readCookieParam(
          pe.optanonCookieName,
          pe.geolocationCookiesParam
        );
    ...
    (Ae.prototype.getGeolocationURL = function (e) {
      ...
      var t =
        "" +
        pe.stubScriptElement.getAttribute("src").split(pe.stubFileName)[0] +
        e.Version;
    ...
    (Ae.prototype.setOTDataLayer = function () {
      ...
      this.otDataLayer = {
        ignore: i,
        name:
          pe.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer",
      };
    }),
        ...
        if (
          ((s.onload = function (e) {
            ...
            this && this.responseText
              ? (t = this.responseText)
              : e && e.target && (t = e.target.responseText),
              n ? o(JSON.parse(t), n) : o(JSON.parse(t));
          }),
          (s.onerror = function () {
            o();
          }),
          s.open("GET", e),
          t && s.setRequestHeader("accept", "application/json"),
          i)
        )
    ...
    (Ae.prototype.jsonp = function (e, t) {
      ...
      o.setAttribute("src", e),
        ...
        new RegExp("^file://", "i").test(e) || pe.mobileOnlineURL.push(e),
        t &&
          (o.onload = o.onerror =
            function () {
              t();
    ...
    (Ae.prototype.validateIABGlobalScope = function () {
      var e = this.readCookieParam(
        pe.optanonCookieName,
        pe.oneTrustIsIABCrossConsentEnableParam
      );
      e
        ? "true" === e
          ? ((pe.hasIABGlobalScope = !0), (pe.isStubReady = !1))
          : ((pe.hasIABGlobalScope = !1),
            (pe.IABCookieValue = this.getCookie(pe.oneTrustIABCookieName)))
        : (pe.isStubReady = !1);
    }),
    (Ae.prototype.validateIABGDPRApplied = function () {
      ...
      e
        ? this.isBoolean(e)
          ? (pe.oneTrustIABgdprAppliesGlobally = "true" === e)
          : (pe.oneTrustIABgdprAppliesGlobally = 0 <= pe.EUCOUNTRIES.indexOf(e))
        : (pe.isStubReady = !1);
    }),
    ...
    (Ae.prototype.updateGtmMacros = function () {
      ...
      for (e = 0; e < o; e++)
        this.endsWith(pe.optanonHtmlGroupData[e], ":1") &&
          t.push(pe.optanonHtmlGroupData[e].replace(":1", ""));
      for (o = pe.optanonHostData.length, e = 0; e < o; e++)
        this.endsWith(pe.optanonHostData[e], ":1") &&
          t.push(pe.optanonHostData[e].replace(":1", ""));
      for (o = pe.genVendorsData.length, e = 0; e < o; e++)
        this.endsWith(pe.genVendorsData[e], ":1") &&
          t.push(pe.genVendorsData[e].replace(":1", ""));
      for (o = pe.vendorsServiceData.length, e = 0; e < o; e++)
        this.endsWith(pe.vendorsServiceData[e], ":1") &&
          t.push(pe.vendorsServiceData[e].replace(":1", ""));
      var i = "," + this.serialiseArrayToString(t) + ",";
      (window.OnetrustActiveGroups = i), (window.OptanonActiveGroups = i);
      var n = window;
      this.otDataLayer.ignore || void 0 === n[this.otDataLayer.name]
        ? this.otDataLayer.ignore ||
          (n[this.otDataLayer.name] = [
            { event: "OneTrustLoaded", OnetrustActiveGroups: i },
            { event: "OptanonLoaded", OptanonActiveGroups: i },
          ])
        : n[this.otDataLayer.name].constructor === Array &&
          (n[this.otDataLayer.name].push({ OnetrustActiveGroups: i }),
          n[this.otDataLayer.name].push({ OptanonActiveGroups: i }));
      var a,
    ...
    (Ae.prototype.setStubScriptElement = function () {
      pe.stubScriptElement = document.querySelector(
        "script[src*='" + pe.stubFileName + "']"
      );
      var e =
        pe.stubScriptElement &&
        0 <= pe.stubScriptElement.getAttribute("src").indexOf("did=");
      pe.stubScriptElement &&
      pe.stubScriptElement.hasAttribute(pe.DATAFILEATTRIBUTE)
        ? (this.domainId = pe.stubScriptElement
            .getAttribute(pe.DATAFILEATTRIBUTE)
            .trim())
        : e
        ? (this.domainId = pe.stubScriptElement
            .getAttribute("src")
        ...
        : pe.stubScriptElement ||
          ((pe.stubScriptElement = document.querySelector(
            "script[src*='" + pe.migratedCCTID + "']"
          )),
          pe.stubScriptElement &&
            ((pe.isMigratedURL = !0),
            (this.domainId = pe.migratedDomainId.trim())));
    }),
    (Ae.prototype.setDomainDataFileURL = function () {
      ...
      e &&
        (pe.isMigratedURL
          ? (pe.storageBaseURL = e.split("/consent/" + pe.migratedCCTID)[0])
          : (pe.storageBaseURL = t
              ? e.split("/consent")[0]
              : e.split("/scripttemplates/" + pe.stubFileName)[0])),
        (this.storageBaseURL = pe.storageBaseURL),
        this.isPreview && -1 === this.domainId.indexOf("test")
          ? (this.domainId = this.domainId + "-test")
          : (this.isPreview = !1),
        (pe.bannerBaseDataURL =
          pe.storageBaseURL && pe.storageBaseURL + "/consent/" + this.domainId),
        (pe.bannerDataParentURL =
          pe.bannerBaseDataURL + "/" + this.domainId + ".json");
    }),
    ...
    (this.iabType = null),
      ...
      (this.addBannerSDKScript = function (e) {
        ...
        [
          ...
          pe.stubScriptElement.getAttribute(e) &&
            o.setAttribute(e, pe.stubScriptElement.getAttribute(e));
        }),
          (c.charset = pe.stubScriptElement.getAttribute("charset")),
          (c.isAmp = !!pe.stubScriptElement.getAttribute("amp")),
          (window.otStubData = {
      ...
      (this.executeCmpApi = function () {
        ...
        if ("function" == typeof n && o)
          if (pe.isStubReady && pe.IABCookieValue)
            switch (o) {
              case "ping":
