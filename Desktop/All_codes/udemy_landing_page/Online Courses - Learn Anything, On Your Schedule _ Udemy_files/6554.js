...
(AWIN.Tracking = AWIN.Tracking || {}),
    ...
    if (!document.getElementById("d9tag")) {
      ...
      if (AWIN.Tracking.device9 && "no" != n) {
        ...
        (t.type = "text/javascript"),
          (t.id = "d9tag"),
          (t.async = !0),
          (t.src = AWIN.Tracking.device9Url);
  ...
  (AWIN.Tracking._getCookieDomain = function () {
    ...
    var t = e.split(".").pop();
    return AWIN.tldDomains.indexOf(t) >= 0
  ...
  (AWIN.Tracking._getAWCValue = function () {
    for (
      var e, n = /[\?&]awc=(\d+_(\d+)_[0-9a-f]+)/gi, t = 0, r = !1;
      (e = n.exec(AWIN.Tracking._getBrowserSearchBarUrl()));

    )
      t < e[2] && ((t = e[2]), (r = e[1]));
    return r || AWIN.Tracking.getAnchorValue(/awc=[0-9a-z_]+/i);
  }),
  ...
  (AWIN.Tracking.setCookie = function (e, n, t) {
    ...
    if (
      ...
      var a = new Date();
      a.setTime(a.getTime() + 31536e6), t && a.setTime(1e3 * t);
  ...
  (AWIN.Tracking.scriptAppend = function (e, n, t, r, a) {
    if (!e || !n) {
      ...
      if (
        ...
        for (var c in r) i.setAttribute(c, r[c]);
      t &&
  ...
  (AWIN.scriptsLoader = function (e) {
    e: for (var n = 0; n < e.length; n++) {
      for (var t = e[n], r = 0; r < t.aRequiredVars.length; r++)
        try {
          if (void 0 === eval(t.aRequiredVars[r])) throw new Error();
        } catch (e) {
          continue e;
        }
      t.sUrl
        ? AWIN.Tracking.scriptAppend(t.sUrl)
        : t.sContents && AWIN.Tracking.scriptAppend(null, t.sContents);
    }
  }),
  ...
  (AWIN.Tracking.basketSubmit = function () {
    ...
    for (r = 0; r < t.length; r++)
      t[r].length > 0 &&
        ((AWIN.Tracking.BasketImages[r] = new Image(1, 1)),
        (AWIN.Tracking.BasketImages[r].src =
          AWIN.sProtocol + "www.zenaps.com/basket.php?product_line=" + t[r]));
  }),
      ...
      if (n[t].length > 0) {
        ...
        try {
          e.push({
            id: r[3].replace(/^\[|\]$/gi, ""),
            name: r[4].replace(/^\[|\]$/gi, ""),
            price: r[5].replace(/^\[|\]$/gi, ""),
            quantity: r[6].replace(/^\[|\]$/gi, ""),
            sku: r[7].replace(/^\[|\]$/gi, ""),
            cg: r[8].replace(/^\[|\]$/gi, ""),
            category: r[9].replace(/^\[|\]$/gi, ""),
          });
        } catch (n) {
          return e;
        }
  ...
  (AWIN.Tracking.embedIframe = function (e) {
    if (!document.getElementById("AW_ALT")) {
      if ("set" == e) {
        var n =
            "https://www.zenaps.com/alt.php?mid=" +
        ...
        var r = AWIN.Tracking.buildSaleUrl("et");
        n =
          "https://www.zenaps.com/alt.php?mid=" +
          AWIN.Tracking.iMerchantId +
          "&gv=2&l=" +
    ...
    if ("fc" != e && "et" != e) {
      (t = "&cks=" + AWIN.Tracking.sCookiesString),
        AWIN.Tracking.awcStorages &&
          (r = "&awc_st=" + escape(AWIN.Tracking.awcStorages));
  ...
  (AWIN.Tracking.fetchZxParam = function (e) {
    var n = window["zx_" + e],
      t = AWIN.Tracking.getQueryVarValue(
        "zx_" + e,
        document.location.search.substring(1)
      ),
      r = AWIN.Tracking.getXPath('//*[@id="zx_' + e + '"]').next();
    if (null !== r) {
      n = null;
      var a = r.innerHTML;
    }
  ...
  (AWIN.Tracking.refreshAWCookies = function () {
    for (var e = AWIN.Tracking.getAWCookies(), n = 0; n < e.length; n++) {
      var t = e[n][0],
        r = e[n][1];
      AWIN.Tracking.setCookie(t, r, 1);
      var a = r.split("_"),
        i = 31536e3 + parseInt(a[1]);
      AWIN.Tracking.setCookie(t, r, i);
    }
  }),
  ...
  (function (e) {
    ...
    (e.checkForSnParameter = function () {
      ...
      (e.getGdprAppends = function (e, n, t) {
        if (e) {
          var r = n + "gdpr=${GDPR}&gdpr_consent=${GDPR_CONSENT_" + e + "}";
  ...
  (AWIN.SandBoxGenerator = (function () {
    ...
    function t(t, r) {
      ...
      return (
        (function (t, r) {
          (t.plugin.publisherId = e),
            (t.plugin.advertiserId = AWIN.Tracking.iMerchantId),
            (t.plugin.protocol = AWIN.sProtocol),
            (t.plugin.awc = n),
            (t.advertiser.config = AWIN.Tracking[r]);
        })(a, r),
        t.accessConfig.zxParams &&
          (function (e, n) {
            n.length > 0 && (e.zxParams = {});
            for (var t = 0; t < n.length; t++)
              e.zxParams[n[t]] = AWIN.Tracking.fetchZxParam(n[t]);
          })(a.plugin, t.accessConfig.zxParams),
        t.accessConfig.location && (a.plugin.location = document.location),
        t.accessConfig.referrer && (a.plugin.referrer = document.referrer),
        t.accessConfig.sale && (a.plugin.sale = AWIN.Tracking.Sale),
        t.accessConfig.basket &&
    ...
    return {
      generate: function (e, n) {
        var r =
            ...
            JSON.stringify(t(AWIN.Tracking[n], n)) +
            ';AWIN.pluginName = "' +
            n +
  ...
  (AWIN.Tracking.iMerchantId = 6554),
  ...
  (AWIN.Tracking.AdvancedClickStorage = (function () {
    var e = {
        removeExpiredItems: function (e) {
          ...
          for (var t in e)
            new Date(e[t].expires) < Date.now() && (delete e[t], (n = !0));
          return n;
        },
        addObjToList: function (e, n, t) {
          var r = new Date();
          t
            ? r.setTime(r.getTime() + 1e3 * t)
            : r.setTime(r.getTime() + 31536e6);
          var a = { value: n, expires: r.toGMTString() };
          if (e) {
            var i,
              c = !1;
                    ...
                    i.clone()
                      ...
                      .then(function (a) {
                        a &&
                          ...
                          removed && n.put(r, new Response(JSON.stringify(a)))),
                          t(a);
                      })
                      .catch(a);
                  })
              ...
              caches
                ...
                .then(function (n) {
                  t(r)
                    .then(function (t) {
                      t || (t = {});
                      var r = e.buildObj(i, c);
                      (t[a] = r),
                        n.put(o, new Response(JSON.stringify(t))),
                        s();
                    })
                    .catch(A);
                })
      ...
      t = (function () {
        function n(n) {
          ...
          return (
            t &&
              e.removeExpiredItems(t) &&
              localStorage.setItem(n, JSON.stringify(t)),
            t
          );
        }
        return {
          set: function (t, r, a, i) {
            var c = n(t);
            c || (c = {});
            var o = e.buildObj(a, i);
            (c[r] = o), localStorage.setItem(t, JSON.stringify(c));
          },
          get: n,
        };
      })();
    function r(e, n, t) {
      if (n)
        for (var r in n)
          n[r].value in e || (e[n[r].value] = {}), (e[n[r].value][t] = "");
    }
    return {
      set: function (e, r, a, i) {
        return (
          t.set(e, r, a, i),
          new Promise(function (t, c) {
            n.set(e, r, a, i).then(t).catch(c);
          })
        );
      },
      get: function (e, a, i) {
            ...
            n.get(e)
              .then(function (e) {
                ...
                for (var i in c) {
                  n.push(i);
                  var o = [];
                  for (var s in c[i]) o.push(s);
                  a.push(o.join("-"));
                }
                t({ data: n.toString(), storages: a.join(",") });
              })
              .catch(function () {
                var e = [],
                  n = [];
                for (var r in c) e.push(r), n.push(c[r].join("-"));
                t({ data: e.toString(), storages: n.join(",") });
              });
          })
        );
      },
  ...
  (AWIN.Tracking.StorageProvider = (function () {
    function e(e, n, t) {
      AWIN.Tracking.AdvancedClickStorage &&
        ...
        AWIN.Tracking.AdvancedClickStorage.set(e, n, t).catch(function () {});
    }
    return {
      setAWC: function (n, t) {
        e("awc_store", n, t);
      ...
      get: function (e, n) {
        if ("function" == typeof Promise) {
          ...
          AWIN.Tracking.AdvancedClickStorage.get("sn_store", e)
            .then(function (r) {
              r.storages &&
                (r.storages.indexOf("cc") > -1 ||
                  r.storages.indexOf("ls") > -1) &&
                ...
                t
                  ...
                  : ((AWIN.Tracking.awcStorages = r.storages), n(r.data));
            })
            .catch(function () {
              n(e);
            });
